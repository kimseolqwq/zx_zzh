    ...
    with SessionLocal() as db:
        ...
        write_csv(
            ...
            [
                ...
                "wireless_charging_w", "wireless_charging_supported", "weight_g",
                "thickness_mm", "waterproof", "waterproof_supported", "nfc", "five_g",
                "screen_shape", "telephoto", "operating_system", "image_url",
            ...
            (
                (
                    ...
                    p.wireless_charging_w, p.wireless_charging_supported, p.weight_g,
                    p.thickness_mm, p.waterproof, p.waterproof_supported, p.nfc, p.five_g,
                    p.screen_shape, p.telephoto, p.operating_system, p.image_url,
                    p.image_source_url, p.official_url,
